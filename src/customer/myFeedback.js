...
export default class MyFeedback extends React.Component {
    ...
    getAllMyEnquiry = () => {
        ...
        let url = URL + 'customer/getAllFeedbackForCustomerId?customerId=' + customerId;
            ...
            <div >
                <ExpansionPanel expanded={this.state.expanded === 'panel1'}
                    ...
                    <ExpansionPanelSummary
                        ...
                        id="panel1bh-header"
                    >
                        <Typography>My Feedback/Benefits </Typography>
                    ...
                    <ExpansionPanelDetails style={{ display: 'block' }}>
                        ...
                        <MaterialTable
                            style={{ width: '100%' }}
                            title="My Feedback/Benefits"
                            columns={[

                                { title: 'Received Date', field: 'enquiryCreatedDate' },
                                { title: 'Question', field: 'enquiryQuestion' },
                                { title: 'Replied Date', field: 'enquiryResolvedDate' },
                                { title: 'Answer', field: 'enquiryAnswer' },
                ...
                <ExpansionPanel expanded={this.state.expanded === 'panel2'}
                    ...
                    <ExpansionPanelSummary
                        ...
                        id="panel2bh-header"
                    >
                        <Typography >Feedback/Benefits Details</Typography>
                        ...
                        <div style={{ textAlign: 'left' }}>
                            ...
                            {this.state.detailButtonclicked === 'serviceHistory' ?
                                <div style={{ borderStyle: 'solid', borderWidth: '0.5px' }}>
                                    <h3>Feedback/Benefits History</h3>
                                    ...
                                    <div>
                                        <b>Customer Feedback/Benefits Details:</b>
                                        <TextField
                                    ...
                                    <br></br>
                                    <div>
                                        <span><b>Feedback/Benefits Comments&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</b></span>
                                        <TextField
